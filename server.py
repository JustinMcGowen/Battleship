...
#processes a shot from a remote client
def shot(x,y):
    x=int(x)
    y=int(y)
...
#returns the character of a x-y coordinate in file
...
#counts total number of fires on a board
...
#default file paths - dont need to be used
my_board = r"C:\Users\Justin\Documents\MSU_Classes\Networks\own_board.txt"
...
#gets post arguments
            ...
            board.close()
            #sends different codes based on errors or successful hits
            ...
            conn.close()
            #prints board between every move
            print("My Board:")
